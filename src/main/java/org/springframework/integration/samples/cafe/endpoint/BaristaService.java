...
package org.springframework.integration.samples.cafe.endpoint;
...
public class BaristaService {
    ...
    public Drink prepareHotDrink(OrderItem orderItem) {
        try {
            ...
            log.info(Thread.currentThread().getName() + " prepared hot drink #"
                    + this.hotDrinkCounter.incrementAndGet() + " for order #" + orderItem.getOrderNumber() + ": "
                    + orderItem);
